...
export default function Login({onLogin}){
 ...
 async function submit(e){
  ...
  if(email===SUPER_ADMIN_EMAIL){const {error:be}=await bootstrapSuperAdmin();if(be){await supabase.auth.signOut();setBusy(false);setError(be.message||"Sign in failed.");return}}
